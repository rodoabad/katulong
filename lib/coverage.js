...
const handler = argv => {
    ...
    shell.exec(`${utils.pkgPath}/.bin/babel-node ${utils.nodeModulesPath}/isparta/bin/isparta cover --report html ${utils.nodeModulesPath}/mocha/bin/_mocha -- ${argv.files} --reporter min`);
